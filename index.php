...
<!--web development-->
        <div class="row align-items-center component">
            ...
            <div class="col-md-5 text">
                ...
                <p>
                    ...
                    leg je door middel van goede code. Onze developers weten exact hoe...
                </p>
                <a href="websites.php">
        ...
        <div class="row align-items-center">
            <div class="col-md-5 text">
                ...
                <p>
                    ...
                    verwachten. Wij zorgen ervoor dat jouw visie en...
                </p>
                <a href="websites.php">
                    <button type="button" class="btn btn-dark">Meer informatie</button>
                </a>
